terraform {
  source = "tfr:///oracle-terraform-modules/terraform-oci-tdf-subnet/oci?ref=main"
}
...
inputs = {
  ...
  subnets = {
    public = {
      ...
      route_table_id     = dependency.vcn.outputs.ig_route_all_attributes[0]["route_table_id"]
    }
  }
}